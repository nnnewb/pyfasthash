...
template <>
const spooky_hash_v1_128_t::hash_value_t spooky_hash_v1_128_t::operator()(void *buf, size_t len,
                                                                          spooky_hash_v1_128_t::seed_value_t seed) const {
...
template <>
const spooky_hash_v2_128_t::hash_value_t spooky_hash_v2_128_t::operator()(void *buf, size_t len,
                                                                          spooky_hash_v2_128_t::seed_value_t seed) const {
    uint64_t lo = U128_LO(seed), hi = U128_HI(seed);

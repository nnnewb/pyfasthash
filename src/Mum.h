...
template <typename T> class mum_hash_t : public Hasher<mum_hash_t<T>, T> {
  public:
...
template <>
const mum_hash_64_t::hash_value_t mum_hash_64_t::operator()(void *buf, size_t len,
                                                            mum_hash_64_t::seed_value_t seed) const {

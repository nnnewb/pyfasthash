...
template <typename T> class hightway_hash_t : public Hasher<hightway_hash_t<T>, uint256_t, T> {
  public:
...
template <>
const highway_hash_64_t::hash_value_t highway_hash_64_t::operator()(void *buf, size_t len,
                                                                    highway_hash_64_t::seed_value_t seed) const {
    highwayhash::HHResult64 result;
    highwayhash::InstructionSets::Run<highwayhash::HighwayHash>(*reinterpret_cast<const highwayhash::HHKey *>(&seed),
...
template <>
const highway_hash_128_t::hash_value_t highway_hash_128_t::operator()(void *buf, size_t len,
                                                                      highway_hash_128_t::seed_value_t seed) const {
...
template <>
const highway_hash_256_t::hash_value_t highway_hash_256_t::operator()(void *buf, size_t len,
                                                                      highway_hash_256_t::seed_value_t seed) const {

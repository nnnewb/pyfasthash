...
template <typename T, typename S, murmur_hash_t TYPE> class murmur_t : public Hasher<murmur_t<T, S, TYPE>, S, T> {
  public:
...
template <>
const murmur1_32_t::hash_value_t murmur1_32_t::operator()(void *buf, size_t len,
                                                          murmur1_32_t::seed_value_t seed) const {
    return MurmurHash1(buf, (int)len, seed);
}

template <>
const murmur1_aligned_32_t::hash_value_t
murmur1_aligned_32_t::operator()(void *buf, size_t len, murmur1_aligned_32_t::seed_value_t seed) const {
    return MurmurHash1Aligned(buf, (int)len, seed);
}

template <>
const murmur2_32_t::hash_value_t murmur2_32_t::operator()(void *buf, size_t len,
                                                          murmur2_32_t::seed_value_t seed) const {
    return MurmurHash2(buf, (int)len, seed);
}

template <>
const murmur2a_32_t::hash_value_t murmur2a_32_t::operator()(void *buf, size_t len,
                                                            murmur2a_32_t::seed_value_t seed) const {
    return MurmurHash2A(buf, (int)len, seed);
}

template <>
const murmur2_aligned_32_t::hash_value_t
murmur2_aligned_32_t::operator()(void *buf, size_t len, murmur2_aligned_32_t::seed_value_t seed) const {
    return MurmurHashAligned2(buf, (int)len, seed);
}

template <>
const murmur2_neutral_32_t::hash_value_t
murmur2_neutral_32_t::operator()(void *buf, size_t len, murmur2_neutral_32_t::seed_value_t seed) const {
    return MurmurHashNeutral2(buf, (int)len, seed);
}

template <>
const murmur2_x64_64a_t::hash_value_t murmur2_x64_64a_t::operator()(void *buf, size_t len,
                                                                    murmur2_x64_64a_t::seed_value_t seed) const {
    return MurmurHash64A(buf, (int)len, seed);
}

template <>
const murmur2_x86_64b_t::hash_value_t murmur2_x86_64b_t::operator()(void *buf, size_t len,
                                                                    murmur2_x86_64b_t::seed_value_t seed) const {
    return MurmurHash64B(buf, (int)len, seed);
}

template <>
const murmur3_32_t::hash_value_t murmur3_32_t::operator()(void *buf, size_t len,
                                                          murmur3_32_t::seed_value_t seed) const {
    unsigned int hash = 0;
...
template <>
const murmur3_x86_128_t::hash_value_t murmur3_x86_128_t::operator()(void *buf, size_t len,
                                                                    murmur3_x86_128_t::seed_value_t seed) const {
    uint128_t hash = 0;
...
template <>
const murmur3_x64_128_t::hash_value_t murmur3_x64_128_t::operator()(void *buf, size_t len,
                                                                    murmur3_x64_128_t::seed_value_t seed) const {
    uint128_t hash = 0;

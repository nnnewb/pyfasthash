...
template <>
const murmur1_aligned_32_t::hash_value_t murmur1_aligned_32_t::operator()(void *buf, size_t len,
                                                                          murmur1_aligned_32_t::seed_value_t seed) const {
...
template <>
const murmur2_aligned_32_t::hash_value_t murmur2_aligned_32_t::operator()(void *buf, size_t len,
                                                                          murmur2_aligned_32_t::seed_value_t seed) const {
    return MurmurHashAligned2(buf, (int)len, seed);
}

template <>
const murmur2_neutral_32_t::hash_value_t murmur2_neutral_32_t::operator()(void *buf, size_t len,
                                                                          murmur2_neutral_32_t::seed_value_t seed) const {

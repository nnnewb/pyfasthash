...
template <bool ORDER> class lookup3_t : public Hasher<lookup3_t<ORDER>, uint32_t> {
  public:
...
template <>
const lookup3_little_t::hash_value_t lookup3_little_t::operator()(void *buf, size_t len,
                                                                  lookup3_little_t::seed_value_t seed) const {
    return hashlittle(buf, len, seed);
}

template <>
const lookup3_big_t::hash_value_t lookup3_big_t::operator()(void *buf, size_t len,
                                                            lookup3_big_t::seed_value_t seed) const {

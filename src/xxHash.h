...
template <typename T> class xx_hash_t : public Hasher<xx_hash_t<T>, T> {
  public:
...
template <>
const xx_hash_32_t::hash_value_t xx_hash_32_t::operator()(void *buf, size_t len,
                                                          xx_hash_32_t::seed_value_t seed) const {
    return XXH32(buf, len, seed);
}
template <>
const xx_hash_64_t::hash_value_t xx_hash_64_t::operator()(void *buf, size_t len,
                                                          xx_hash_64_t::seed_value_t seed) const {
    return XXH64(buf, len, seed);
}

template <typename T> class xxh3_hash_t : public Hasher<xxh3_hash_t<T>, T> {
  public:
...
template <>
const xxh3_hash_64_t::hash_value_t xxh3_hash_64_t::operator()(void *buf, size_t len,
                                                              xxh3_hash_64_t::seed_value_t seed) const {
    return XXH3_64bits_withSeed(buf, len, seed);
}

#ifdef SUPPORT_INT128
template <>
const xxh3_hash_128_t::hash_value_t xxh3_hash_128_t::operator()(void *buf, size_t len,
                                                                xxh3_hash_128_t::seed_value_t seed) const {

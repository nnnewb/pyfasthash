...
template <typename T> class spooky_hash_v1_t : public Hasher<spooky_hash_v1_t<T>, T> {
  public:
...
template <>
const spooky_hash_v1_32_t::hash_value_t spooky_hash_v1_32_t::operator()(void *buf, size_t len,
                                                                        spooky_hash_v1_32_t::seed_value_t seed) const {
    return SpookyHashV1::Hash32(buf, len, seed);
}

template <>
const spooky_hash_v1_64_t::hash_value_t spooky_hash_v1_64_t::operator()(void *buf, size_t len,
                                                                        spooky_hash_v1_64_t::seed_value_t seed) const {
...
template <>
const spooky_hash_v1_128_t::hash_value_t
spooky_hash_v1_128_t::operator()(void *buf, size_t len, spooky_hash_v1_128_t::seed_value_t seed) const {
...
template <typename T> class spooky_hash_v2_t : public Hasher<spooky_hash_v2_t<T>, T> {
  public:
...
template <>
const spooky_hash_v2_32_t::hash_value_t spooky_hash_v2_32_t::operator()(void *buf, size_t len,
                                                                        spooky_hash_v2_32_t::seed_value_t seed) const {
    return SpookyHashV1::Hash32(buf, len, seed);
}

template <>
const spooky_hash_v2_64_t::hash_value_t spooky_hash_v2_64_t::operator()(void *buf, size_t len,
                                                                        spooky_hash_v2_64_t::seed_value_t seed) const {
    return SpookyHashV1::Hash64(buf, len, seed);
}
...
template <>
const spooky_hash_v2_128_t::hash_value_t
spooky_hash_v2_128_t::operator()(void *buf, size_t len, spooky_hash_v2_128_t::seed_value_t seed) const {
    uint64_t lo = U128_LO(seed), hi = U128_HI(seed);
